...
The features in this release:
    ...
    - Improved BIOS installation using encryptedPasswordFile through command line interface.
    - Enhanced toast notification mechanism during driver installations.

********************************************************************************
Important Information
********************************************************************************

NOTE: DCU Classic interface will not be supported from version 4.7.1 onwards and the older DCU Classic clients will be upgraded to DCU version 4.8 UWP.
